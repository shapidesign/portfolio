...
assert(categoryOf(["kids-t-shirt"]) === "kids-t-shirt", "kids collection");
...
assert(categoryOf(["kids-t-shirt", "toddler-shirts"]) === "kids-t-shirt", "kids before toddler in display order");
